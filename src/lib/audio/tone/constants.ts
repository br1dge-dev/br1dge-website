...
// Cinematic note collections
export const NOTES = {
  // Organ-like bass foundation (very low, felt more than heard)
  subBass: ['G0', 'G1'],
  
  // Main drone notes - perfect 5ths for power
  droneFifths: ['G1', 'D2', 'G2', 'D3'],
  
  // Pad voicings - open, cinematic (no 3rds for ambiguity)
  ...
  // SFX - Collect sounds (ascending through scale)
  collectScale: ['G4', 'Bb4', 'C5', 'D5', 'F5', 'G5'],
  
  // Level up - triumphant open voicing
  levelUpChord: ['G3', 'D4', 'G4', 'D5', 'G5'],
  
  // Max stack - massive cinematic chord
  maxStackChord: ['G2', 'D3', 'G3', 'Bb3', 'D4', 'F4', 'G4'],
  
  // Chamber capture - crystalline
  chamberScale: ['D5', 'G5', 'D6', 'G6', 'D7'],
  
  // Bridge spawn - heroic motif
  bridgeChord: ['G3', 'D4', 'G4', 'B4', 'D5'],
  
  // Collection complete - resolution
  completeArpeggio: ['G4', 'D5', 'G5'],
};
